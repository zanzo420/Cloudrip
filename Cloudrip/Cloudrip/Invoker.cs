...
namespace Cloudrip
{
    static class Invoker
    {
        ...
        private delegate void _ChangeImage(Control control, Image image);
        ...
        public static void ChangeImage(Control control, Image image)
        {
            try
            {
                InvokedControl(control, new _ChangeImage(ChangeImage), control, image).Image = image;
            }
            catch { }
        }
